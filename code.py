...
data = pd.read_csv('C:\Users\Violetta\github\myapp-project')
...
sns.countplot(x='D',data = dataset)


# In[6]:

data_preprocessing = dataset.copy()
data_preprocessing.drop(['NO', 'D'], axis = 1, inplace = True)
...
normalized_data.columns = ['Treated_D', 'Treated_YR', 'Treated_R1', 'Treated_R2', 'Treated_R3', 'Treated_R4', 'Treated_R5', 'Treated_R6', 'Treated_R7', 'Treated_R8', 'Treated_R9', 'Treated_R10', 'Treated_R11', 'Treated_R12', 'Treated_R13', 'Treated_R14', 'Treated_R15', 'Treated_R16', 'Treated_R17', 'Treated_R18', 'Treated_R19', 'Treated_R20', 'Treated_R21',	'Treated_R22', 'Treated_R23', 'Treated_R24']
...
dataset.to_csv('C:\Users\Violetta\github\myapp-project\Bankruptcy.csv', sep=',')


# In[18]:

data = dataset.copy()
data.drop(['NO', 'D', 'YR',	'R1', 'R2', 'R3', 'R4',	'R5', 'R6',	'R7', 'R8',	'R9', 'R10', 'R11', 'R12', 'R13', 'R14', 'R15', 'R16', 'R17', 'R18', 'R19',	'R20', 'R21', 'R22', 'R23',	'R24'], axis = 1, inplace = True),
...
data.to_csv('C:\Users\Violetta\github\myapp-project\data.csv', sep=',')
...
train_one = pd.read_csv("C:\Users\Violetta\github\myapp-project\train_subset_one.csv")
train_one.head()
...
# Displaying the frequency chart for output variable (bstatus = bankruptcy status)
plt.figure(figsize=(10,6))
sns.countplot(x='YR',data = train_one)
...
y, X = dmatrices('YR ~ Treated_D + Treated_YR + Treated_R1 + Treated_R2 + Treated_R3 + Treated_R4 + Treated_R5 + Treated_R6 + Treated_R7 + Treated_R8 + Treated_R9 + Treated_R10 + Treated_R11 + Treated_R12 + Treated_R13 + Treated_R14 + Treated_R15 + Treated_R16 + Treated_R17 + Treated_R18 + Treated_R19 + Treated_R20 + Treated_R21 + Treated_R22 + Treated_R23 + Treated_R24', train_one, return_type="dataframe")
print (X.columns)
...
train_two = pd.read_csv("C:\Users\Violetta\github\myapp-project\train_subset_two.csv")
train_two.head()


# In[33]:

y2, X2 = dmatrices('YR ~ Treated_D + Treated_YR + Treated_R1 + Treated_R2 + Treated_R3 + Treated_R4 + Treated_R5 + Treated_R6 + Treated_R7 + Treated_R8 + Treated_R9 + Treated_R10 + Treated_R11 + Treated_R12 + Treated_R13 + Treated_R14 + Treated_R15 + Treated_R16 + Treated_R17 + Treated_R18 + Treated_R19 + Treated_R20 + Treated_R21 + Treated_R22 + Treated_R23 + Treated_R24', train_two, return_type="dataframe")
print (X2.columns)
# flatten y into a 1-D array
y2 = np.ravel(y2)
...
train_three = pd.read_csv("C:\Users\Violetta\github\myapp-project\train_subset_three.csv")
train_three.head()


# In[43]:

y3, X3 = dmatrices('YR ~ Treated_D + Treated_YR + Treated_R1 + Treated_R2 + Treated_R3 + Treated_R4 + Treated_R5 + Treated_R6 + Treated_R7 + Treated_R8 + Treated_R9 + Treated_R10 + Treated_R11 + Treated_R12 + Treated_R13 + Treated_R14 + Treated_R15 + Treated_R16 + Treated_R17 + Treated_R18 + Treated_R19 + Treated_R20 + Treated_R21 + Treated_R22 + Treated_R23 + Treated_R24', train_three, return_type="dataframe")
print (X3.columns)
# flatten y into a 1-D array
y3 = np.ravel(y3)
...
test_data = pd.read_csv("C:\Users\Violetta\github\myapp-project\test_data_new.csv")
test_data.head()
...
# Displaying the frequency chart for output variable (bstatus = bankruptcy status)
plt.figure(figsize=(10,6))
sns.countplot(x='YR',data = test_data)


# In[51]:

y_test, X_test = dmatrices(YR ~ Treated_D + Treated_YR + Treated_R1 + Treated_R2 + Treated_R3 + Treated_R4 + Treated_R5 + Treated_R6 + Treated_R7 + Treated_R8 + Treated_R9 + Treated_R10 + Treated_R11 + Treated_R12 + Treated_R13 + Treated_R14 + Treated_R15 + Treated_R16 + Treated_R17 + Treated_R18 + Treated_R19 + Treated_R20 + Treated_R21 + Treated_R22 + Treated_R23 + Treated_R24', test_data, return_type="dataframe")
